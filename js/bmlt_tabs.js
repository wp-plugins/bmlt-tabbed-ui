...
function goToGoogleMaps(startingLocation, destination) {
	var url = "https://www.google.com/maps/embed/v1/directions?origin="+startingLocation+"&destination="+destination+"&key=AIzaSyDjKpHiNtvvK-2VhtZGg8pN-y7D_TLcyYs"
   ...
   jQuery("#divId").html('<iframe id="modalIframeId" width="100%" height="100%" marginWidth="0" marginHeight="0" frameBorder="0" scrolling="auto" />').dialog("open");
   
   jQuery("#modalIframeId").attr("src",url);
   
}

function getMap(lat, lon) {

//https://www.google.com/maps/place/28%C2%B031'44.2%22N+81%C2%B025'15.3%22W/@28.528944,-81.420916,1436m/data=!3m1!1e3!4m2!3m1!1s0x0:0x0
//https://www.google.com/maps/embed/v1/place?q=38.2213698%2C-84.53824929999999&key=AIzaSyDjKpHiNtvvK-2VhtZGg8pN-y7D_TLcyYs
//https://www.google.com/maps/embed/v1/view?key=API_KEY&center=-33.8569,151.2152&zoom=18&maptype=satellite

https://www.google.com/maps/embed/v1/place/28%C2%B042'44.8%22N+81%C2%B019'28.3%22W/@28.7123072,-81.324076,718m/data=!3m1!1e3!4m2!3m1!1s0x0:0x0
